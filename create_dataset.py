...
if __name__ == '__main__':
    ...
    # import shutil
    # data_dir = "/home/dao/PycharmProjects/viSRL/Propbank_tiengViet/PropBank-HTB-8.9/annotation"
    # folders = os.listdir(data_dir)
    # for folder in folders:
    #     folder_name = os.path.join(data_dir, folder)
    #     files = os.listdir(folder_name)
    #     file = folder + "_" + files[0]
    #     file_org = os.path.join(folder_name, files[0])
    #     file_copy = os.path.join(data_dir1, file)
    #     shutil.copy2(file_org, file_copy)
